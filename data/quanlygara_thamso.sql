...
CREATE TABLE `thamso` (
  `SoXeNhanToiDa` int(100) NOT NULL,
  `SoLuongHieuXe` int(100) NOT NULL,
  `TiLeTinhDonGiaBan` int(100) NOT NULL,
  `SoLuongVTPT` int(100) NOT NULL,
  `SoLuongTienCong` int(100) NOT NULL,
  `KiemTraSoTienThu` int(100) NOT NULL
...
INSERT INTO `thamso` VALUES (30,12,25,200,100,0);

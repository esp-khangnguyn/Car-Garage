         ...
         <div class="container-heading">
            <form method="POST" action="page3.php">
               <div class="col-sm-12 col-xs-12">
                  <a href="#" class="btn btn-sm btn-primary fa-pull-left mb-1 ticket-button" onclick="Supplies()">
         ...
         <table class="table table-responsive  table-hover">
            <thead>
               <tr class="text-center">
                  <th class="col-3" style="border-top-left-radius: 12px;">Tên vật liệu</th>
      ...
      <div class="add-supplies-root hidden">
         <form class="add-supplies-root" method="POST" action="page3_add.php">
            ...
            <div class="year-select d-flex justify-content-center align-items-center mb-3 ">
               <input name="date" style="width: 200px; height: 32px; margin-right: 10px;" type="date" placeholder="Thời gian" required>
            </div>
               ...
               <tbody class="table table-striped ">
                     <div class="ele">
                        <tr style="font-size: 14px;">
                           ...
                           <td class="col-2">
                              <div class="d-flex justify-content-center">
                                 <input type="number" min="0" name="amount" class="form-control" aria-label="Number" aria-describedby="basic-addon1">
                              </div>
                           </td>
                           <td class="col-2">
                              <div class="d-flex justify-content-center">
                                 <input type="number" min="0" name="price" class="form-control" aria-label="Number" aria-describedby="basic-addon1">
                              </div>
                           </td>
                           <td class="col-5">
                              <div class="d-flex justify-content-center">
